/**
 * @(#)The1MinuteSolverService 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
 *
 * <P>The <code>The1MinuteSolverService</code> is the The1Minute Solver's Web Service facade. 
 *
 * </p>
 ...
 * @since OS 1.0
 */
public class The1MinuteSolverService implements OShL{
	/**
	 ...
	 * default constructor.
	 */
	public The1MinuteSolverService(){
		...
		try {
			String sClassName = OSParameter.SOLVER_CLASS_NAME; //"org.optimizationservices.ossolver.solver.The1MinuteSolver";
			Class solverClass = Class.forName(sClassName);
			m_osServiceUtil.solver =(DefaultSolver)solverClass.newInstance();
			//m_osServiceUtil.solver = new The1MinuteSolver();
		} 
		catch (Exception e) {
	 ...
	 */
	static{
		//OSParameterFile.NAME = IOUtil.getCurrentDir()+ "webapps/the1minute/code/OSConfig/OSParameter_The1Minute.xml";
		OSParameterFile.NAME = "/home/kmartin/bin/tomcat/webapps/the1minute/code/OSConfig/OSParameter_The1Minute.xml";
		//OSParameterFile.NAME = "/code/OSConfig/OSParameter_The1Minute.xml"; 

	}//static constructor
}//class The1MinuteSolverService
