/**
 * @(#)OSnLNodeEULERGAMMA 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
 *
 * <P>The <code>OSnLNodeEULERGAMMA</code> class represents a EULERGAMMA constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeEULERGAMMA extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "EULERGAMMA";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "EULERGAMMA constant";
	 ...
	 * constructor
	 */
	protected OSnLNodeEULERGAMMA(){
	}//constructor

	/**
	 * Calculate the result value of EULERGAMMA constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of EULERGAMMA constant given the current variable values.
	 */
	protected double calculateFunction(double[] x){
		m_dFunctionValue = 0.577216;
	...
	/**
	 * Calculate the result value of EULERGAMMA constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of EULERGAMMA constant derivative given the current variable values.
	 */
