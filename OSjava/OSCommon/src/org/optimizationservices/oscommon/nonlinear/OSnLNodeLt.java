...
/**
 *
 * <P>The <code>OSnLNodeLt</code> class represents an lt (or less than) relational node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeLt extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "lt";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "Lt (or less than) relational node";
	 ...
	 * @param rightNode
	 */
	protected OSnLNodeLt(OSnLNode leftNode, OSnLNode rightNode){
	 ...
	 * Default Constructor
	 */
	protected OSnLNodeLt(){
		m_mChildren = new OSnLNode[2];
	}//constructor


	/**
	 * Calculate the result value of lt (or less than) relational operator given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of lt (or less than) relational operator given the current variable values.
	 */
	...
	/**
	 * Calculate the result value of lt (or less than) relational operator derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of lt (or less than) relational operator derivative given the current variable values.
	 */
