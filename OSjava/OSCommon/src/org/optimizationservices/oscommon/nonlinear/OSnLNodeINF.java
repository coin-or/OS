...
/**
 *
 * <P>The <code>OSnLNodeINF</code> class represents a INF (or infinity) constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeINF extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "INF";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "INF (or infinity) constant";
	 ...
	 * constructor
	 */
	protected OSnLNodeINF(){
	}//constructor

	/**
	 * Calculate the result value of INF constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of INF constant given the current variable values.
	 */
	protected double calculateFunction(double[] x){
		m_dFunctionValue = Double.POSITIVE_INFINITY;
	...
	/**
	 * Calculate the result value of INF constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of INF constant derivative given the current variable values.
	 */
