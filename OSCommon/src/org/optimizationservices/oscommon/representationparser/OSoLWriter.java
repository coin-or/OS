...
public class OSoLWriter extends OSgLWriter{
	 ...
	 * @param values holds the values of the other options, empty string "" if no value for an option.
	 * @param descriptions holds the descriptions of the other options, empty string "" if no value for an option, null for
	 * the entire array if none of the options have descriptions.
	 ...
	 * @param value holds the value of the other option element, empty string "" if none. 
	 * @param description holds the description of the other option element, empty string "" if none. 
	...
	public static void main(String[] argv){
		...
		if(!osolWriter.setContactAddress("contactAddress")) System.out.println("setContactAddress Unsuccessful");		
		if(!osolWriter.setSystemMinDiskSpace(10)) System.out.println("setSystemMinDiskSpace Unsuccessful");		
