...
/**
 *
 * <P>The <code>OSnLNodeNAN</code> class represents a NAN (or not a number) constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeNAN extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "NAN";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "NAN (or not a number) constant";
	 ...
	 * constructor
	 */
	protected OSnLNodeNAN(){
	}//constructor

	/**
	 * Calculate the result value of NAN constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of NAN constant given the current variable values.
	 */
	...
	/**
	 * Calculate the result value of NAN constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of NAN constant derivative given the current variable values.
	 */
	protected double calculateDerivative(double[] x, int index, boolean functionEvaluated){
		double dDerivative = Double.NaN;
		return dDerivative;
	}//calculateDerivative
