...
/**
 *
 * <P>The <code>OSnLNodeFALSE</code> class represents a FALSE boolean constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeFALSE extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "FALSE";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "FALSE boolean constant";
	 ...
	 * constructor
	 */
	protected OSnLNodeFALSE(){
	}//constructor

	/**
	 * Calculate the result value of FALSE constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of FALSE constant given the current variable values.
	 */
	...
	/**
	 * Calculate the result value of FALSE constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of FALSE constant derivative given the current variable values.
	 */
