...
/**
 *
 * <P>The <code>OSnLNodeE</code> class represents an exponential E constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeE extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "E";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "Exponential E constant";
	...
	/**
	 * Calculate the result value of exponential E constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of exponential E constant given the current variable values.
	 */
	protected double calculateFunction(double[] x){
		m_dFunctionValue = Math.E;
	...
	/**
	 * Calculate the result value of exponential E constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of exponential E constant derivative given the current variable values.
	 */
