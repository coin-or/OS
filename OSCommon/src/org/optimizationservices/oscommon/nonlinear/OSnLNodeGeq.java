...
/**
 *
 * <P>The <code>OSnLNodeGeq</code> class represents a geq (or greater than or equal to) relational node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeGeq extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "geq";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "Geq (or greater than or equal to) relational node";
	 ...
	 * @param rightNode
	 */
	protected OSnLNodeGeq(OSnLNode leftNode, OSnLNode rightNode){
	 ...
	 * Default Constructor
	 */
	protected OSnLNodeGeq(){
		m_mChildren = new OSnLNode[2];
	}//constructor


	/**
	 * Calculate the result value of geq (or greater than or equal to) relational operator given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of geq (or greater than or equal to) relational operator given the current variable values.
	 */
	...
	/**
	 * Calculate the result value of geq (or greater than or equal to) relational operator derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of geq (or greater than or equal to) relational operator derivative given the current variable values.
	 */
