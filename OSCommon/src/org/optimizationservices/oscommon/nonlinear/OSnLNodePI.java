...
/**
 *
 * <P>The <code>OSnLNodePI</code> class represents a PI constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodePI extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "PI";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "PI constant";
	 ...
	 * constructor
	 */
	protected OSnLNodePI(){
	}//constructor

	/**
	 * Calculate the result value of PI constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of PI constant given the current variable values.
	 */
	protected double calculateFunction(double[] x){
		m_dFunctionValue = Math.PI;
	...
	/**
	 * Calculate the result value of PI constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of PI constant derivative given the current variable values.
	 */
