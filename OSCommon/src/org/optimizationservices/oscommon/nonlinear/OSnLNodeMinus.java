...
/**
 *
 * <P>The <code>OSnLNodeMinus</code> class represents a subtraction node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeMinus extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "minus";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "Subtraction of 2 node operands";
	 ...
	 * </p>
	 *
	 * @param leftNode holds the left node operand to be subtracted.
	 * @param rightNode holds the right node operand to subract.
	 */
	protected OSnLNodeMinus(OSnLNode leftNode, OSnLNode rightNode){
	 ...
	 * Default Constructor
	 */
	protected OSnLNodeMinus(){
		m_mChildren = new OSnLNode[2];
	}//constructor


	/**
	 * Calculate the result value of subtraction given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of subtraction given the current variable values.
	 */
	...
	/**
	 * Calculate the result value of subtraction derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of subtraction derivative given the current variable values.
	 */
