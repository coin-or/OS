...
/**
 *
 * <P>The <code>OSnLNodeXor</code> class represents an xor (or exclusive or) conditional logic node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeXor extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "xor";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "Xor (or exclusive or) conditional logic node";
	 ...
	 * @param rightNode
	 */
	protected OSnLNodeXor(OSnLNode leftNode, OSnLNode rightNode){
	 ...
	 * Default Constructor
	 */
	protected OSnLNodeXor(){
		m_mChildren = new OSnLNode[2];
	}//constructor


	/**
	 * Calculate the result value of xor conditional logic operator given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of xor conditional logic operator given the current variable values.
	 */
	...
	/**
	 * Calculate the result value of xor conditional logic operator derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of xor conditional logic operator derivative given the current variable values.
	 */
	protected double calculateDerivative(double[] x, int index, boolean functionEvaluated){
		...
		//(left, right) in {Boolean, Real}
			...
			if(dLeftDerivative == Double.NEGATIVE_INFINITY && dRightDerivative > Double.NEGATIVE_INFINITY) dDerivative = Double.POSITIVE_INFINITY;
			else if(dLeftDerivative == Double.POSITIVE_INFINITY && dRightDerivative > Double.NEGATIVE_INFINITY) dDerivative = Double.NEGATIVE_INFINITY;
			...
			if((dLeftDerivative == 0 && dRightDerivative < 0) || (dLeftDerivative == Double.POSITIVE_INFINITY && dRightDerivative == 0)) dDerivative = Double.POSITIVE_INFINITY;
			else if((dLeftDerivative == 0 && dRightDerivative > 0) || (dLeftDerivative == Double.NEGATIVE_INFINITY && dRightDerivative == 0)) dDerivative = Double.NEGATIVE_INFINITY;
			else if(Double.isNaN(dRightDerivative) || (Double.isNaN(dLeftDerivative) && dRightDerivative == 0)) dDerivative = Double.NaN;
			else dDerivative = 0;
		}
		else if(dLeft == OSnLNode.m_dTRUE && dRight < 0){
			if(dLeftDerivative == Double.POSITIVE_INFINITY && dRightDerivative < Double.POSITIVE_INFINITY) dDerivative = Double.POSITIVE_INFINITY;
			...
			if((dLeftDerivative == 0 && dRightDerivative < 0) || (dLeftDerivative == Double.NEGATIVE_INFINITY && dRightDerivative == 0)) dDerivative = Double.NEGATIVE_INFINITY;
			else if((dLeftDerivative == 0 && dRightDerivative > 0) || (dLeftDerivative == Double.POSITIVE_INFINITY && dRightDerivative == 0)) dDerivative = Double.POSITIVE_INFINITY;
			else if(Double.isNaN(dRightDerivative) || (Double.isNaN(dLeftDerivative) && dRightDerivative == 0)) dDerivative = Double.NaN;
			else dDerivative = 0;
		}
		else if(dLeft == OSnLNode.m_dFALSE && dRight < 0){
		...
		//(left, right) in {Real, Boolean}
			...
			if(dRightDerivative == Double.NEGATIVE_INFINITY && dLeftDerivative > Double.NEGATIVE_INFINITY) dDerivative = Double.POSITIVE_INFINITY;
			else if(dRightDerivative == Double.POSITIVE_INFINITY && dLeftDerivative > Double.NEGATIVE_INFINITY) dDerivative = Double.NEGATIVE_INFINITY;
			...
			if((dRightDerivative == 0 && dLeftDerivative < 0) || (dRightDerivative == Double.POSITIVE_INFINITY && dRightDerivative == 0)) dDerivative = Double.POSITIVE_INFINITY;
			else if((dRightDerivative == 0 && dLeftDerivative > 0) || (dRightDerivative == Double.NEGATIVE_INFINITY && dLeftDerivative == 0)) dDerivative = Double.NEGATIVE_INFINITY;
			else if(Double.isNaN(dLeftDerivative) || (Double.isNaN(dRightDerivative) && dLeftDerivative == 0)) dDerivative = Double.NaN;
			else dDerivative = 0;
		}
		else if(dLeft < 0 && dRight == OSnLNode.m_dTRUE){
			if(dRightDerivative == Double.POSITIVE_INFINITY && dLeftDerivative < Double.POSITIVE_INFINITY) dDerivative = Double.POSITIVE_INFINITY;
			...
			if((dRightDerivative == 0 && dLeftDerivative < 0) || (dRightDerivative == Double.NEGATIVE_INFINITY && dLeftDerivative == 0)) dDerivative = Double.NEGATIVE_INFINITY;
			else if((dRightDerivative == 0 && dLeftDerivative > 0) || (dRightDerivative == Double.POSITIVE_INFINITY && dLeftDerivative == 0)) dDerivative = Double.POSITIVE_INFINITY;
			else if(Double.isNaN(dLeftDerivative) || (Double.isNaN(dRightDerivative) && dLeftDerivative == 0)) dDerivative = Double.NaN;
			else dDerivative = 0;
		}
		else if(dLeft < 0 && dRight == OSnLNode.m_dFALSE){
		...
		//(left, right) in {Real, Real}
			...
			else if(dRightDerivative > 0 && dLeftDerivative != Double.NEGATIVE_INFINITY && !Double.isNaN(dLeftDerivative))dDerivative = Double.NEGATIVE_INFINITY;
			else if(Double.isNaN(dRightDerivative) || (dLeftDerivative == Double.NEGATIVE_INFINITY || Double.isNaN(dLeftDerivative))) dDerivative = Double.NaN;
			else dDerivative = 0;
		}
		else if(dLeft < 0 && dRight == 0){
			if(dRightDerivative > 0 && dLeftDerivative != Double.POSITIVE_INFINITY && !Double.isNaN(dLeftDerivative))dDerivative = Double.POSITIVE_INFINITY;
			...
			else if(dLeftDerivative > 0 && dRightDerivative != Double.NEGATIVE_INFINITY && !Double.isNaN(dRightDerivative))dDerivative = Double.NEGATIVE_INFINITY;
			else if(Double.isNaN(dLeftDerivative) || (dRightDerivative == Double.NEGATIVE_INFINITY || Double.isNaN(dRightDerivative))) dDerivative = Double.NaN;
			else dDerivative = 0;
		}
		else if(dLeft == 0 && dRight < 0){
			if(dLeftDerivative > 0 && dRightDerivative != Double.POSITIVE_INFINITY && !Double.isNaN(dRightDerivative))dDerivative = Double.POSITIVE_INFINITY;
			...
			if((dLeftDerivative == 0 && dRightDerivative > 0) || (dRightDerivative == 0 && dLeftDerivative > 0)) dDerivative = Double.POSITIVE_INFINITY;
			else if((dLeftDerivative == 0 && dRightDerivative < 0) || (dRightDerivative == 0 && dLeftDerivative < 0)) dDerivative = Double.NEGATIVE_INFINITY;
