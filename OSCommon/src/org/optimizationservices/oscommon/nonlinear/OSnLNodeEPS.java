...
/**
 *
 * <P>The <code>OSnLNodeEPS</code> class represents a EPS (or epsilon) constant node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeEPS extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "EPS";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "EPS (or epsilon) constant";
	 ...
	 * constructor
	 */
	protected OSnLNodeEPS(){
	}//constructor

	/**
	 * Calculate the result value of EPS constant given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of EPS constant given the current variable values.
	 */
	protected double calculateFunction(double[] x){
		m_dFunctionValue = 1e-15;
	...
	/**
	 * Calculate the result value of EPS constant derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of EPS constant derivative given the current variable values.
	 */
