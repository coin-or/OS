...
/**
 *
 * <P>The <code>OSnLNodeNeq</code> class represents an neq (or not equal) relational node in an expression tree.
 ...
 * @since OS 1.0
 */
public class OSnLNodeNeq extends OSnLNode{

	/**
	 * m_sSymbol holds the symbol that this nlNode looks in ASCII.
	 */
	protected String m_sSymbol = "neq";

	/**
	 * m_sSymbol holds the description of this nlNode
	 */
	protected String m_sDescription = "Neq (or not equal) relational node";
	 ...
	 * @param rightNode
	 */
	protected OSnLNodeNeq(OSnLNode leftNode, OSnLNode rightNode){
	 ...
	 * Default Constructor
	 */
	protected OSnLNodeNeq(){
		m_mChildren = new OSnLNode[2];
	}//constructor


	/**
	 * Calculate the result value of neq (or not equal) relational operator given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @return the result value of neq (or not equal to) relational operator given the current variable values.
	 * If the left node's calculated value is not equal to right node's calculated value, return TRUE.
	 * Else, return FALSE.
	 */
	...
	/**
	 * Calculate the result value of neq (or not equal to) relational operator derivative given the current variable values.
	 *
	 * </p>
	 *
	 * @param x holds the values of the variables in a double array.
	 * @param functionEvaluated holds whether the function has been evaluated.
	 * @return the result value of neq (or not equal to) relational operator derivative given the current variable values.
	 */
