...
/**
*
* <P>The <code>CLPSolver</code>class is the real CLP computing engine. 
*
* </p>
...
* @since OS 1.0
*/
public class CLPSolver extends DefaultSolver{
	...
	/**
	 * run the CLP solver command that is specified in the batch file. 
	 */
	public void solve(){
