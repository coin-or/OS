...
/**
*
* <P>The <code>CPLEXSolver</code>class is the real CPLEX computing engine. 
*
* </p>
...
* @since OS 1.0
*/
public class CPLEXSolver extends DefaultSolver{
	...
	/**
	 * run the CPLEX solver command that is specified in the batch file. 
	 */
	public void solve(){
