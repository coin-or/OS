/**
 * @(#)The1MinuteSolver 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
*
* <P>The <code>The1MinuteSolver</code>class is a computing engine that always takes 1 minute. 
*
* </p>
...
* @since OS 1.0
*/
public class The1MinuteSolver extends DefaultSolver{

	/**
	 * default constructor.
	 */
	public The1MinuteSolver(){
	}//constructor

	/**
	 * run the The1Minute solver command that is specified in the batch file. 
	 */
	public void solve(){
