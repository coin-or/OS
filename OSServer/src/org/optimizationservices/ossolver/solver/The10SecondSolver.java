/**
 * @(#)The10SecondSolver 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
*
* <P>The <code>The10SecondSolver</code>class is a computing engine that always takes 10 seconds. 
*
* </p>
...
* @since OS 1.0
*/
public class The10SecondSolver extends DefaultSolver{

	/**
	 * default constructor.
	 */
	public The10SecondSolver(){
	}//constructor

	/**
	 * run the The10Second solver command that is specified in the batch file. 
	 */
	public void solve(){
