/**
 * @(#)The3MinuteSolverService 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
 *
 * <P>The <code>The3MinuteSolverService</code> is the The3Minute Solver's Web Service facade. 
 *
 * </p>
 ...
 * @since OS 1.0
 */
public class The3MinuteSolverService implements OShL{
	/**
	 ...
	 * default constructor.
	 */
	public The3MinuteSolverService(){
		...
		try {
			String sClassName = OSParameter.SOLVER_CLASS_NAME; //"org.optimizationservices.ossolver.solver.The3MinuteSolver";
			Class solverClass = Class.forName(sClassName);
			m_osServiceUtil.solver =(DefaultSolver)solverClass.newInstance();
			//m_osServiceUtil.solver = new The3MinuteSolver();
		} 
		catch (Exception e) {
	 ...
	 */
	static{
		//OSParameterFile.NAME = IOUtil.getCurrentDir()+ "webapps/the3minute/code/OSConfig/OSParameter_The3Minute.xml";
		OSParameterFile.NAME = "/home/kmartin/bin/tomcat/webapps/the3minute/code/OSConfig/OSParameter_The3Minute.xml";
		//OSParameterFile.NAME = "/code/OSConfig/OSParameter_The3Minute.xml"; 

	}//static constructor
}//class The3MinuteSolverService
