/**
 * @(#)CGSolverService 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
 *
 * <P>The <code>CGSolverService</code> is the CG Solver's Web Service facade. 
 *
 * </p>
 ...
 * @since OS 1.0
 */
public class CGSolverService implements OShL{
	/**
	...
	public CGSolverService(){
		...
		try {
			String sClassName = OSParameter.SOLVER_CLASS_NAME; //"org.optimizationservices.ossolver.solver.CGSolver";
	...
	static{
		...
		OSParameterFile.NAME = "/code/OSConfig/OSParameter_CGSolverService.xml";
	}//static constructor
}//class CGSolverService
