/**
 * @(#)CLPSolverService 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
...
/**
 *
 * <P>The <code>CLPSolverService</code> is the CLP Solver's Web Service facade. 
 *
 * </p>
 ...
 * @since OS 1.0
 */
public class CLPSolverService implements OShL{
	/**
	...
	public CLPSolverService(){
		...
		try {
			String sClassName = OSParameter.SOLVER_CLASS_NAME; //"org.optimizationservices.ossolver.solver.CLPSolver";
			Class solverClass = Class.forName(sClassName);
			m_osServiceUtil.solver =(DefaultSolver)solverClass.newInstance();
			//m_osServiceUtil.solver = new CLPSolver();
		} 
		catch (Exception e) {
	 ...
	 */
	static{
		//OSParameterFile.NAME = IOUtil.getCurrentDir()+ "webapps/clp/code/OSConfig/OSParameter_CLP.xml";
		OSParameterFile.NAME = "/home/kmartin/bin/tomcat/webapps/clp/code/OSConfig/OSParameter_CLP.xml";
		//OSParameterFile.NAME = "/code/OSConfig/OSParameter_CLP.xml"; //same as c:/code/

	}//static constructor
}//class CLPSolverService
