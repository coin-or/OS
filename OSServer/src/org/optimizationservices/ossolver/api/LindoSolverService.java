...
/**
 *
 * <P>The <code>LindoSolverService</code> is the Lindo solver's Web Service facade. 
 *
 * </p>
...
public class LindoSolverService implements OShL{
	/**
	 * m_osServiceUtil holds a default implementation of the lindo solver service.
	 */
	 ...
	 */
	static{
		OSParameterFile.NAME = "/home/kmartin/bin/tomcat/webapps/lindo/code/OSConfig/OSParameter_Lindo.xml";
	}//static constructor
