/**
 * @(#)LindOldSolverService 1.0 03/14/2004
 *
 * Copyright (c) 2004
 */
 ...
 * @since OS 1.0
 */
public class LindoOldSolverService implements OShL{
	...
	public String solve(String osil, String osol){
		...
		//solve
		LindoOldSolver lindoSolver = new LindoOldSolver();
	...
	public static void main(String[] argv){
		LindoOldSolverService lindoSolverService = new LindoOldSolverService();
		String sOSiL;
