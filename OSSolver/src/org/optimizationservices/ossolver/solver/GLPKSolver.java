...
/**
*
* <P>The <code>GLPKSolver</code>class is the real GLPK computing engine. 
*
* </p>
...
* @since OS 1.0
*/
public class GLPKSolver extends DefaultSolver{
	...
	/**
	 * run the GLPK solver command that is specified in the batch file. 
	 */
	public void solve(){
