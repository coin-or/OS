...
/**
*
* <P>The <code>CBCSolver</code>class is the real CBC computing engine. 
*
* </p>
...
* @since OS 1.0
*/
public class CBCSolver extends DefaultSolver{
	...
	/**
	 * run the CBC solver command that is specified in the batch file. 
	 */
	public void solve(){
		...
		String sSolver = "cbc"; //"coin_solver_cbc";
		String sArguments = 
			" -osil " + sInstanceFile + 
			" -osol " + sOptionFile +
			" -osrl " + sResultFile + 
