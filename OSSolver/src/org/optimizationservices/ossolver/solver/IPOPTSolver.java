...
/**
*
* <P>The <code>IPOPTSolver</code>class is the real IPOPT computing engine. 
*
* </p>
...
* @since OS 1.0
*/
public class IPOPTSolver extends DefaultSolver{
	...
	/**
	 * run the IPOPT solver command that is specified in the batch file. 
	 */
	public void solve(){
