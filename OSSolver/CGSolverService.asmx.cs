...
public class CGSolverService : System.Web.Services.WebService, OShL{
	/// <summary>
	...
	public CGSolverService(){
		...
		try {
			...
			//string sSolverClassName = "org.optimizationservices.ossolver.solver.CGSolver";
			Type solverType;
	...
	/// static constructor
	/// </summary>
	static CGSolverService(){
		OSParameterFile.NAME = "c:/code/OSConfig/OSParameter_CGSolverService.xml";
	}//static constructor
}//CGSolverService
