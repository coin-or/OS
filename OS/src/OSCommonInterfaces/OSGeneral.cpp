...
bool OtherMatrixVariableOptionOrResult::IsEqual(OtherMatrixVariableOptionOrResult *that)
{
    ...
    else
    {
        ...
        for (unsigned int i = 0; i < this->numberOfMatrixVar; i++)
        {
            if (this->matrixVar[i] == NULL)
            {
                if (that->matrixVar[i] != NULL)
                    return false;
            }
            else
...
bool OtherMatrixObjectiveOptionOrResult::IsEqual(OtherMatrixObjectiveOptionOrResult *that)
{
    ...
    else
    {
        ...
        for (unsigned int i = 0; i < this->numberOfMatrixObj; i++)
        {
            if (this->matrixObj[i] == NULL)
            {
                if (that->matrixObj[i] != NULL)
                    return false;
            }
            else
...
bool OtherMatrixConstraintOptionOrResult::IsEqual(OtherMatrixConstraintOptionOrResult *that)
{
    ...
    else
    {
        ...
        for (unsigned int i = 0; i < this->numberOfMatrixCon; i++)
        {
            if (this->matrixCon[i] == NULL)
            {
                if (that->matrixCon[i] != NULL)
                    return false;
            }
            else
