...
public:
	...
	/** this parameter holds the output generated by the 
	 *  executeCommandMethod(). The format of this output depends
	 *  on the value of parameter serviceMethod and whether
	 *  executeServiceMethod() terminated successfully or not.
	 *  If serviceMethod is solve or retrieve, resultString is in OSrL
	 *  format; if kill or knock it is OSpL format; if getJobID it is a 
	 *  string containing the job ID. If executeServiceMethod encountered
	 *  an error, then resultString may contain a local error message.
	 */
