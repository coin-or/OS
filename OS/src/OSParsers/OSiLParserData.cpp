...
//    variablecoefattON(false),
    ...
    matrixIdxAttributePresent(false),
    lbMatrixIdxAttributePresent(false),
    lbConeIdxAttributePresent(false),
    ubMatrixIdxAttributePresent(false),
    ubConeIdxAttributePresent(false),
    orderConeIdxAttributePresent(false),
    templateMatrixIdxAttributePresent(false),
    constantMatrixIdxAttributePresent(false),
    varReferenceMatrixIdxAttributePresent(false),
    objReferenceMatrixIdxAttributePresent(false),
    conReferenceMatrixIdxAttributePresent(false),
