...
\item[] {\bf -osplInput xxx.osrl}\ \  The name of an input file in the  OS Process Language (OSpL), this is used as input  to the {\tt knock} method.

\item[] {\bf -osplOutput xxx.osrl}\ \  The name of an output file in the  OS Process Language (OSpL), this the  output  string from the {\tt knock}  and {\tt kill} method.
