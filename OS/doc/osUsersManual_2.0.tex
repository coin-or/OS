...
The Cbc, Clp and SYMPHONY solvers are all invoked by creating a {\tt CoinSolver().} For example, 
the following is used to invoke Cbc.
...
\item[Step 5:] After optimizing the instance, the solver writes the result to a string 
...
We then use the {\tt OSResult} API methods 
