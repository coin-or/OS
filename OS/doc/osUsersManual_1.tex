...
Users on a Unix system such as Linux, Solaris, Mac OS X, etc. should follow Steps 1 trough 6 listed below.   Windows users should  skip ahead and read Section \ref{section:windowsinstall}.
...
\subsection{Windows Installations}\label{section:windowsintall}
