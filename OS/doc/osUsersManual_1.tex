...
give the URL for the version of the OS project you wish to check out, for instance, \url{https://projects.coin-or.org/svn/OS/stable/1.0}.
...
give the URL for the version of the OS project you wish to checkout, e.g., \url{https://projects.coin-or.org/svn/OS/stable/1.0}.
...
\item{} In the project root run {\tt make install.}

\item{} Either leave {\tt matlabSolver.cpp} in the  the {\tt OSModelInterfaces} or copy it to another desired directory.
...
\item{} \label{itemize:tomcatwin2}  Connect to the Tomcat {\tt bin} directory in the {\tt os-server-1.0} root and execute
\begin{verbatim}
service.bat install
\end{verbatim}
...
\item{}  \label{itemize:tomcatwin4} Select the {\tt Startup} tab and set the {\tt Working Directory} to the path to {\tt os-server-1.0}.
...
\section{Building a Model in MATLAB} \label{section:matlab}
