...
\item [Step 5:] This step is necessary only if you wish to build with the AMPL {\tt ASL} solver library.   Unfortunately, and we regret this, but at the time of this writing the working version of ASL is its trunk version. This means that it is necessary to download the trunk version separately and replace the release version we have distributed with the trunk version.  The URL for the trunk version is
