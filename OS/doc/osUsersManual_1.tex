...
\item [Step 5:] This step is necessary only if you wish to build with the AMPL {\tt ASL} solver library.   Unfortunately, and we regret this, at the time of this writing the working version of ASL for cygwin/cl build is its trunk version. Therefore it is necessary to download the trunk version separately and replace the release version we have distributed with the trunk version.  The URL for the trunk version is
