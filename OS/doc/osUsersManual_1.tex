...
On Windows with TortoiseSVN, create a directory {\tt COIN-OS} in the desired location and right-click on this directory.   Select the menu item {\tt SVN Checkout ...} and put in https://projects.coin-or.org/svn/OS/stable/1.0 as URL of repository.
...
\noindent {\bf Step 1:}  Connect to the distribution root directory.
...
\noindent {\bf Step 5:}  Install the libraries.  In addition you will have the following directories.
