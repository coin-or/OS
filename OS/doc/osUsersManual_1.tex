...
\subsubsection{The Remote {\tt solve} Service Method}
...
<osol xmlns="os.optimizationservices.org">
    <general>
        <serviceURI>http://128.135.130.17:8080/os/OSSolverService.jws</serviceURI>
         <instanceLocation locationType="local">/home/kmartin/files/code/OSRepository/linear/continuous/pilot.osil</instanceLocation>
    </general>
    <optimization>
    	<other name="os_solver">clp</other>
    </optimization>
...
<osol xmlns="os.optimizationservices.org">
    <general>
        <serviceURI>http://128.135.130.17:8080/os/OSSolverService.jws</serviceURI>
         <instanceLocation locationType="http">http://gsbkip.chicagogsb.edu/testproblems/parincLinear.osil</instanceLocation>
    </general>
    <optimization>
    	<other name="os_solver">clp</other>
    </optimization>
...
\subsubsection{The Remote {\tt send} Service Method}


illustrate getting email with smpt

\subsubsection{The Remote {\tt retrieve} Service Method}



\subsubsection{The Remote {\tt getJobID} Service Method}

\subsubsection{The Remote {\tt knock} Service Method}

\subsubsection{The Remote {\tt kill} Service Method}
