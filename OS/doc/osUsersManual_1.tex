...
Users on a Unix system such as Linux, Solaris, Mac OS X, etc. should follow Steps 1 trough 6 listed below.   Windows users should  skip ahead and read Section 
\ref{section:windowsintall}.
...
\item[Step 5.]  In the MSYS command window connect to the root of the OS project and run  {\tt configure}  script  and then {\tt make} as described in Section \ref{section:svn}.
