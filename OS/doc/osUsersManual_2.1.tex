...
solve;
\end{verbatim}
will result in the remoter solver being called.  Each call 
\begin{verbatim}
option osamplclient_options
\end{verbatim}
...
{\tt <solverToInvoke>} and that the solver given is {\tt symphony}.   This has no effect on a local solve, however if this option file is paired with 
