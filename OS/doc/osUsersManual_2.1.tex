...
C++ {  \bf OSSolverService} executable to solve the problem.\index{Java|)}
...
For instance, {\tt Ipopt} requires derivatives but does not provide its own differentiation routies, 
