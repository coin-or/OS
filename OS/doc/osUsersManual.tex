...
<xs:complexType name="Variable">  <--------------------------------------------->  class Variable\{\\[\Sb]
 ...
 \\[\Sb]
 \\[\Sb]
\textsf{\textbf{OSiL elements          \hspace{1.87in}  In-memory objects}}\\[\Sa]
...
and {\tt type} (char). On the left the corresponding XML complexTypes are shown, with arrows indicating 
