...
\title{Using the CoinAll binaries and libraries (stable version \OSstable )}
\vskip 2in
\author{Horand Gassmann, Jun Ma,  Kipp Martin}
\maketitle

\begin{abstract}
This manual explains how to obtain and use the binary distribution of the CoinAll software, which consists of
the OSSolverService along with several COIN solvers. Through OSSolverService the user can access these solvers 
both on a local machine as well as over the internet. The manual explains how to use the binaries as well as the C++ libraries. 
The latter can be linked again in user-written code. 
\iffalse
provide a
