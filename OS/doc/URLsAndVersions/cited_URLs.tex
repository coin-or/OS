...
\newcommand{\db}{\discretionary{}{}{}} %discretionary line break in overlong URLs
...
\newcommand{\UrlCoinNames}{https://projects.coin-or.org/CoinBinary/wiki/\db ArchiveNamingConventions}
...
\newcommand{\UrlGlpkDownload}{ftp://ftp.gnu.org/gnu/glpk/glpk-4.48.tar.gz}
\newcommand{\UrlGurobi}{http://www.gurobi.com/products/gurobi-optimizer/\db gurobi-overview}
...
\newcommand{\UrlMingw}{http://downloads.sourceforge.net/mingw/MSYS-1.0.11.exe?modtime=1079444447\db\&big\_mirror=1}
\newcommand{\UrlMosek}{http://www.mosek.com/}
\newcommand{\UrlMsys}{http://sourceforge.net/project/showfiles.php?group\_id=2435}
\newcommand{\UrlMsysBinary}{http://downloads.sourceforge.net/mingw/bash-3.1-MSYS-1.0.11-1.tar.bz2\db?modtime=1195140582\&big\_mirror=1}
...
\newcommand{\UrlSdk}{http://www.microsoft.com/downloads/details.aspx\db?FamilyID=E6E1C3DF-A74F-4207-8586-711EBE331CDC\&displaylang=en}
\newcommand{\UrlSoPlexDownload}{http://soplex.zib.de/}
...
\newcommand{\UrlXpress}{http://www.fico.com/en/Products/DMTools/\db xpress-overview/Pages/\db Xpress-Optimizer.aspx}
