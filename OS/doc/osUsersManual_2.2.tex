...
\newcommand{\UrlOsRelease}{https://projects.coin-or.org/svn/OS/releases/2.2.0}
\newcommand{\UrlOsStable}{https://projects.coin-or.org/svn/OS/stable/2.2}
...
\newcommand{\OSstable}{2.2}
\newcommand{\OSrelease}{2.2.0}
...
the configuration and make files\index{makefile|)} accordingly. Once you have downloaded, e.g., Blas\index{Blas}, you must specify
%
\begin{verbatim}
