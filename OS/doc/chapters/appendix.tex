\division{Appendix -- Sample OSiL files}\label{section:appendix}

\index{OSiL|(}
\subdivision{OSiL representation for problem given in (\ref{eq:roobj})--(\ref{eq:ro3}) (p.\pageref{eq:roobj})}\label{section:rosenbrockXML}
...
\ifruncode\else
\subdivision{OSiL representation for problem given in (\ref{eq:adobj})--(\ref{eq:adeq2}) (p.\pageref{eq:adobj})
