...
\end{verbatim}
\else
The binary distribution contains makefiles for unix users, respectively MS Visual Studio project files 
for Windows users that can be used as follows.

Under unix, connect to the appropriate directory for the desired project and run {\tt make}. 
...
Under Windows, connect to the {\tt MSVisualStudio} directory and open {\tt examples.sln} in Visual Studio.
...
%{\tt examples.sln}\index{examples.sln@{\tt examples.sln}} in
