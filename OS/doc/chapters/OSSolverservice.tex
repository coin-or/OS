...
\item[] {\bf serviceMethod  methodName}\ \ This is  the service method to be invoked.
The options are 
{\tt solve}\index{solve@{\tt solve}|(}, 
{\tt send}\index{send@{\tt send}},
{\tt kill}\index{kill@{\tt kill}}, 
...
\item[] {\bf config xxx.config}\ \ This optional parameter specifies a path on the local machine 
