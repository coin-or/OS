...
In order for the browser to find the stylesheet used it is necessary to copy the file
\ifdevelop
...
By adding the {\tt <instanceLocation>} element and setting the {\tt locationType} attribute to {\tt http}  we
could specify the instance location on yet another machine. This is illustrated below  using {\tt remoteSolve2.osol}.
...
{\tt http://www.coin-or.org/OS/p0033.osil} and download this test problem. So the {\tt OSSolverService} is
running on the server {\tt http://74.94.100.129:8080/} which contacts the server {\tt www.coin-or.org} for the model instance.
\begin{verbatim}
<?xml version="1.0" encoding="UTF-8"?>
<osol xmlns="os.optimizationservices.org"
      xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
