...
\ifbible
By using a print level of 100 or higher, the user can control the output from one single area of the code in isolation. For instance, setting {\tt printlevel 107} allows finely detailed debug information to be generated in the main routine only, while ignoring (almost) all other output. The areas can be read off from the following table.
...
\hline
     ...
     OSoLwriter & 13\\
     OSrLwriter & 14 \\
     OSModelInterfaces & 15 \\
     OSSolverInterfaces & 16 \\
     OSUtils & 17 \\
\hline
\end{tabular}
\fi
