...
\item[4.] Test the examples and applications.  They are in the folder {\tt examples} in the COIN root directory and in folder {\tt applications} in the OS root directory, respectively. Be sure to follow the instructions in chapter~\ref{section:examples} for building these.
