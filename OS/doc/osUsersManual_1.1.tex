...
After successfully running the {\bf make install} you should have in {\bf GAMSlinks} bin folder three files:
\begin{verbatim}
gmsos_.zip
\end{verbatim}

Copy these three files into the your GAMS root folder.  Then run {\bf gamsinstall}.  You can solve solve problems either locally or remotely. To solve a problem locally, call

\begin{verbatim}
gamslib trnsport   (get trnsport model)gams trnsport lp=OS
\end{verbatim}
