...
COIN-OR project CppAD\index{COIN-OR projects!CppAD@{\tt CppAD}} by Brad Bell ({\tt\UrlCppad}) but is written in a very general
...
The COIN-OR project Ipopt\index{COIN-OR projects!Ipopt@{\tt Ipopt}} (see section~\ref{section:ipopt}) and several of the third-party 
...
to {\tt Cbc}\index{COIN-OR projects!Cbc@{\tt Cbc}}, {\tt Clp}\index{COIN-OR projects!Clp@{\tt Clp}}, {\tt Cgl}\index{COIN-OR projects!Cgl@{\tt Cgl}},
{\tt CoinUtils}\index{COIN-OR projects!CoinUtils@{\tt CoinUtils}}, {\tt CppAD}\index{COIN-OR projects!CppAD@{\tt CppAD}}, or {\tt Osi}\index{COIN-OR projects!Osi@{\tt Osi}}.
...
add {\tt Ipopt}\index{COIN-OR projects!Ipopt@{\tt Ipopt}}, {\tt Bonmin}\index{COIN-OR projects!Bonmin@{\tt Bonmin}} and ASL\index{AMPL Solver Library (ASL)}
...
build without {\tt Ipopt}\index{COIN-OR projects!Ipopt@{\tt Ipopt}} or {\tt Bonmin}\index{COIN-OR projects!Bonmin@{\tt Bonmin}}. Issue the following command in the project root.
\begin{verbatim}
...
with the {\tt Ipopt} solver. The solution file for the {\tt Bonmin}\index{COIN-OR projects!Bonmin@{\tt Bonmin}} solver will be
...
{\tt CoinUtils}\index{COIN-OR projects!CoinUtils@{\tt CoinUtils}}, {\tt CppAD}\index{COIN-OR projects!CppAD@{\tt CppAD}},
...
\index{cplex@{\tt cplex}},
{\tt glpk} (GLPK\index{GLPK@{\tt GLPK}} through COIN-OR Osi\index{COIN-OR projects!Osi@{\tt Osi}}),% {\tt ipopt} (COIN-OR Ipopt),
...
then {\tt cbc}\index{COIN-OR projects!Cbc@{\tt Cbc}} is the default value of this parameter if the {\tt solve}\index{solve@{\tt solve}}
