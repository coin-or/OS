...
The AMPL and GAMS modeling languages can be used to generate model instances as input  to an OS compliant solver. In Section \ref{section:amplclient} we described how to hook the AMPL modeling language to solvers using {\bf OSAmplclient}.  It is also possible to use GAMS via the COIN-OR GAMSlinks project. 
